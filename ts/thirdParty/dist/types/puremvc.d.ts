...
declare namespace puremvc {
    ...
    class View implements IView {
         ...
         * @protected
         */
        protected static _instance: IView;
        /**
...
declare namespace puremvc {
    ...
    class Notification implements INotification {
        private static _notificationPool;
        static allocate(name: string, body?: any, type?: string): Notification;
        /**
...
declare namespace puremvc {
    ...
    class MacroCommand extends Notifier implements ICommand, INotifier {
         ...
         * @protected
         */
        protected _subCommands: Function[];
        /**
